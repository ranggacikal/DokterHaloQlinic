...
import id.luvie.luviedokter.model.konsultasiBerlangsung.DataItem;

public class KonsultasiBerlangsungAdapter extends RecyclerView.Adapter<KonsultasiBerlangsungAdapter.KonsultasiBerlangsungViewHolder> {

    Context context;
    List<DataItem> dataKonsultasi;

    public KonsultasiBerlangsungAdapter(Context context, List<DataItem> dataKonsultasi) {
    ...
    @NonNull
    @Override
    public KonsultasiBerlangsungViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_jadwal_konsultasi, parent, false);
        return new KonsultasiBerlangsungViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull KonsultasiBerlangsungViewHolder holder, @SuppressLint("RecyclerView") int position) {
...
//                            intentChat.putExtra("id_customer", dataKonsultasi.get(position).getIdCustomer());
    ...
    public class KonsultasiBerlangsungViewHolder extends RecyclerView.ViewHolder {

        TextView txtNamaDokter, txtWaktu;
        CircleImageView imgPasien;

        public KonsultasiBerlangsungViewHolder(@NonNull View itemView) {
            super(itemView);
