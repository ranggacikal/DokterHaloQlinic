...
public class HistoryChatAdapter extends RecyclerView.Adapter<HistoryChatAdapter.HistoryChatViewHolder> {
    ...
    @Override
    public void onBindViewHolder(@NonNull @NotNull HistoryChatViewHolder holder, @SuppressLint("RecyclerView") int position) {
                    ...
                    public void onClick(View v) {
                        ...
                        if (preferencedConfig.getPreferencePositionFragment().equals("0")) {
                            ...
                            if (status_transaksi.equals("1")){
                                ...
                                intentChat.putExtra("token", (String) dataKonsultasi.get(position).getToken());
